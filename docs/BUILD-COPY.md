...
Call calendar: first Friday 4 Sept ~7pm after 6pm webinar. DMs said أول سبتمبر جمعة — both mean that Friday. Body uses 4 سبتمبر so the clock is real.
...
H1 (her words): حاجتك.
حتى لو صغيرة.
Under H1 (failure mode): مش تفضل قاعد بتفجوليز مع نفسك ومفيش حاجة على الأرض.
...
H2: Workshop. 4 أسابيع. Surround بالبزنس.
...
Eyebrow: بتطلع بإيه
H2: حاجتك. وتفهمي السيكونس.
1. حاجتك / my own thing
2. تفهمي السيكونس ماشي إزاي والميندست بتاعت البزنس
3. ابدأ بfeature واحدة
4. أول client
الأربع جمع: 1 person+problem, 2 offer+v1 of one feature, 3 on the ground in front of people, 4 price + first client.
...
Under button: لو مهتم تحجز هبعتلك رابط الدفع. هدفع باللينك.
...
SEO title: Workshop 0→1 — حاجتك على الأرض | Mentorna
