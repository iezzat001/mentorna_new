...
const PricingSection = () => {
  return (
    <section className="bg-accent-yellow border-b-4 border-foreground py-12 px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="flex justify-center">
          <Card className="
            ...
            w-full
          ">
            <CardHeader className="bg-primary border-b-4 border-foreground text-center p-6">
