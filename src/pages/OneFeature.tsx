...
const OneFeature = () => {
  ...
  return (
    <div className="min-h-screen bg-background" dir="rtl">
      ...
      {/* ===== Section 5: Lead Capture (smart: only asks first-time visitors) ===== */}
      <section className="py-12 md:py-16 bg-gradient-to-br from-primary via-primary/90 to-primary/80 border-b-4 border-foreground">
        <div className="container mx-auto px-4">
          <SmartCapture
            episode={EPISODE}
            blurb="نزّل الـ 1-Feature Validator Canvas (مجاناً) عشان تفلتر أفكارك وتوصل للـ Core Value اللي هتبني عليها الـ Startup بتاعتك في 30 يوم."
          />
        </div>
      </section>
