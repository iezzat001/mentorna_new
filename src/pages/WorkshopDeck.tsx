...
import { slides } from '@/components/slides/workshopSlides';

// Admin-only native mirror of the "Vibe Coding 0 → 1" workshop deck.
// Ported from the public zero-to-one presentation; same slide engine.
const WorkshopDeck = () => {
